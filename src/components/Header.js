<div classNameName="container-fluid slider-container hidden-xs">
						<div className="carousel slide new-destination-page-slider hidden-xs" data-interval="5000" data-pause="false" data-ride="carousel" id="banner-slider">
							...
							<a className="left carousel-control" data-slide="prev" href="#banner-slider" role="button"></a>
							<a className="right carousel-control" data-slide="next" href="#banner-slider" role="button"></a>
						</div>
					</div>